...
const SERVER_URL = process.env.SERVER_URL; // Only set this on Render
...
// ===== HEALTH CHECK (UptimeRobot Support) =====
app.get('/', (req, res) => {
...
Choose option below:`,
  ...
  if (state.step === 'payment') {
    ...
    if (text === 'Send Screenshot') {
      state.step = 'upload';
      return bot.sendMessage(chatId, '📸 Please upload your payment screenshot.');
    }
...
Our sales team will contact you shortly.
  ...
  bot.sendMessage(chatId,
    '✅ You can place a new order. Select a model:',
    { reply_markup: { keyboard: chunkArray(MODELS, 4), resize_keyboard: true } }
  );
}
